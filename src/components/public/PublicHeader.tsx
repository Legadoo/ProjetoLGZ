    ...
    <header className="sticky top-0 z-50 border-b border-purple-500/30 bg-[#050008]/85 backdrop-blur-2xl">
      <div className="lgz-container flex min-h-24 items-center gap-5">
        <Link href="/" className="group flex items-center gap-3">
          <div className="relative grid h-14 w-14 place-items-center rounded-2xl border border-purple-500/50 bg-[radial-gradient(circle,rgba(176,38,255,0.35),rgba(15,0,30,0.9))] text-2xl font-black text-purple-100 shadow-[0_0_28px_rgba(176,38,255,0.28)] transition group-hover:scale-105">
            LGZ
        ...
        <div className="ml-auto hidden items-center gap-3 md:flex">
          ...
          <Link
            href="/cadastro"
            className="lgz-button min-h-12 px-5 text-sm"
          >
            Cadastro
          </Link>
        </div>
